...
public class ApiPontoController {
    ...
    public ResponseEntity<Object> atualizaPonto(@PathVariable("id") long pontoID, @RequestBody PontoDTO pontoAtualizado){
    ...
    public void excuirPonto(@PathVariable("id") long id){pontoService.excluirPonto(id);}
